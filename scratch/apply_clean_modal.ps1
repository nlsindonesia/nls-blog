...
# Replace the modal block from `<!-- ===== POP-UP MODAL FORM KEBUTUHAN PRIVAT SESUAI PAKET ===== -->` to `<!-- Floating Action Button -->`
$newModal = @'
...
# Replace regex matching modal block
...
Write-Host "SUCCESS: Clean modal without template wrapper applied!"
