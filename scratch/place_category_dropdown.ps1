...
# 1. Remove the pills section from Hero banner so Hero is clean & focused
...
# 2. Add the Category Dropdown at the Red "X" position above the article grid
...
# 3. Clean up any corrupted bullet character in cards or modal
$content = $content.Replace('<span>â€¢</span>', '<span class="text-slate-300 dark:text-slate-700">•</span>')
