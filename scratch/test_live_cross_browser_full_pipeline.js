/**
 * Full Pipeline Test: Cross-Browser Real-Time Persistent Cloud Sync
 */
...
function callHandler(handler, method, body = null, query = null) {
    return new Promise((resolve) => {
        ...
        let res = {
            ...
            json(d) { this.data = d; resolve(this); return this; },
...
async function runLiveTest() {
    ...
    const createRes = await callHandler(teacherAppsHandler, 'POST', {
        ...
        subject: 'Mata Pelajaran Uji Coba',
        kebutuhanPrivat: 'Bimbingan intensif UTBK'
    });
