                    ...
                    <div x-data class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch max-w-7xl mx-auto">
                        ...
                        <div
                            ...
                            <div class="flex flex-col flex-1">
                                <!-- Top Badge -->
                                <div class="mb-5 h-8 flex items-center">
                                    <span
                                ...
                                <!-- Diperuntukkan Untuk (Reguler) - Aligned Min Height -->
                                <div class="mb-5 space-y-2.5 min-h-[195px] lg:min-h-[210px] flex flex-col justify-start">
                                    <div style="background: #e0f2fe !important; border: 1px solid #bae6fd !important; color: #0369a1 !important;"
                                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider self-start shadow-2xs">
                                    ...
                                    <div class="space-y-2">
                                        <div style="background: #f0f9ff !important; border: 1.5px solid #bae6fd !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs transition-all hover:border-sky-400">
                                            <span style="background: #0284c7 !important; color: #ffffff !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">1</span>
                                            <span style="color: #0f172a !important;" class="text-xs font-bold leading-snug">Pendampingan siswa Kurikulum Nasional</span>
                                        </div>
                                        <div style="background: #f0f9ff !important; border: 1.5px solid #bae6fd !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs transition-all hover:border-sky-400">
                                            <span style="background: #0284c7 !important; color: #ffffff !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">2</span>
                                            <span style="color: #0f172a !important;" class="text-xs font-bold leading-snug">Persiapan TKA SD, SMP, SMA</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Feature List -->
                                <div class="space-y-3.5 mb-8 min-h-[190px] flex flex-col justify-start">
                        ...
                        <div style="background: linear-gradient(165deg, #0b224d 0%, #061530 100%) !important; color: #ffffff !important; border: 2.5px solid #f59e0b !important; box-shadow: 0 20px 45px -10px rgba(11, 34, 77, 0.6), 0 0 25px rgba(245, 158, 11, 0.3) !important;"
                            class="p-8 md:p-9 rounded-[32px] relative flex flex-col justify-between group z-20">
                            ...
                            <div class="flex flex-col flex-1">
                                ...
                                <!-- Diperuntukkan Untuk (Exclusive) - Aligned Min Height -->
                                <div class="mb-5 space-y-2.5 min-h-[195px] lg:min-h-[210px] flex flex-col justify-start">
                                    <div style="background: rgba(245, 158, 11, 0.25) !important; border: 1px solid rgba(245, 158, 11, 0.6) !important; color: #fde047 !important;"
                                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider self-start shadow-2xs">
                                    ...
                                    <div class="space-y-2">
                                        <div style="background: rgba(255, 255, 255, 0.08) !important; border: 1.5px solid rgba(245, 158, 11, 0.4) !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs backdrop-blur-xs transition-all hover:border-amber-400">
                                            <span style="background: linear-gradient(135deg, #f59e0b, #d97706) !important; color: #0b1727 !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">1</span>
                                            <span style="color: #ffffff !important;" class="text-xs font-bold leading-snug">Persiapan OSN Tingkat Kota/Provinsi (SD, SMP, SMA)</span>
                                        </div>
                                        <div style="background: rgba(255, 255, 255, 0.08) !important; border: 1.5px solid rgba(245, 158, 11, 0.4) !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs backdrop-blur-xs transition-all hover:border-amber-400">
                                            <span style="background: linear-gradient(135deg, #f59e0b, #d97706) !important; color: #0b1727 !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">2</span>
                                            <span style="color: #ffffff !important;" class="text-xs font-bold leading-snug">Pendampingan siswa SD/SMP Kurikulum Internasional</span>
                                        </div>
                                        <div style="background: rgba(255, 255, 255, 0.08) !important; border: 1.5px solid rgba(245, 158, 11, 0.4) !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs backdrop-blur-xs transition-all hover:border-amber-400">
                                            <span style="background: linear-gradient(135deg, #f59e0b, #d97706) !important; color: #0b1727 !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">3</span>
                                            <span style="color: #ffffff !important;" class="text-xs font-bold leading-snug">Persiapan SNBT / Mandiri</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col flex-1">
                                ...
                                <!-- Diperuntukkan Untuk (Juara) - Aligned Min Height -->
                                <div class="mb-5 space-y-2.5 min-h-[195px] lg:min-h-[210px] flex flex-col justify-start">
                                    <div style="background: #f3e8ff !important; border: 1px solid #ddd6fe !important; color: #6b21a8 !important;"
                                        class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider self-start shadow-2xs">
                                    ...
                                    <div class="space-y-2">
                                        <div style="background: #faf5ff !important; border: 1.5px solid #e9d5ff !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs transition-all hover:border-purple-400">
                                            <span style="background: #7c3aed !important; color: #ffffff !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">1</span>
                                            <span style="color: #0f172a !important;" class="text-xs font-bold leading-snug">Persiapan OSN Tingkat Semifinal/Final (SD, SMP, SMA)</span>
                                        </div>
                                        <div style="background: #faf5ff !important; border: 1.5px solid #e9d5ff !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs transition-all hover:border-purple-400">
                                            <span style="background: #7c3aed !important; color: #ffffff !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">2</span>
                                            <span style="color: #0f172a !important;" class="text-xs font-bold leading-snug">Pendampingan siswa SMA Kurikulum Internasional</span>
                                        </div>
                                        <div style="background: #faf5ff !important; border: 1.5px solid #e9d5ff !important;"
                                            class="p-2.5 rounded-xl flex items-start gap-2.5 shadow-2xs transition-all hover:border-purple-400">
                                            <span style="background: #7c3aed !important; color: #ffffff !important;"
                                                class="w-5 h-5 rounded-md flex items-center justify-center text-[11px] font-black shrink-0 mt-0.5 shadow-xs">3</span>
                                            <span style="color: #0f172a !important;" class="text-xs font-bold leading-snug">Persiapan Kompetisi Internasional (AMO, SEAMO, TIMO, dll.)</span>
                                        </div>
                                    </div>
                                </div>
...
Write-Host "SUCCESS: Updated pricing cards with aligned heights and high contrast text!"
