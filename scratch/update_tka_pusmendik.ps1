$tkaPath = "c:\Users\vc\Documents\nls-blog-hame\nls-blog-hame\tka\index.html"
$bimbelTkaPath = "c:\Users\vc\Documents\nls-blog-hame\nls-blog-hame\bimbel-tka\index.html"

$html = [System.IO.File]::ReadAllText($tkaPath, [System.Text.Encoding]::UTF8)

# 1. Update Title and Meta Descriptions
$html = [System.Text.RegularExpressions.Regex]::Replace($html, '<title>.*?</title>', '<title>Bimbel TKA - Persiapan Tes Kemampuan Akademik Pusmendik Kemendikdasmen | Next Level Study</title>', [System.Text.RegularExpressions.RegexOptions]::Singleline)
$html = [System.Text.RegularExpressions.Regex]::Replace($html, '<meta name="description" content=".*?">', '<meta name="description" content="Bimbingan belajar resmi persiapan Tes Kemampuan Akademik (TKA) mengacu pada standar Pusat Asesmen Pendidikan (Pusmendik) Kemendikdasmen RI. Mencakup Mata Pelajaran Wajib (Bahasa Indonesia, Matematika, Bahasa Inggris) dan Mata Pelajaran Pilihan Saintek, Soshum, Bahasa, & Vokasi untuk seleksi SNBP & sekolah lanjutan.">', [System.Text.RegularExpressions.RegexOptions]::Singleline)
$html = [System.Text.RegularExpressions.Regex]::Replace($html, '<meta property="og:title" content=".*?">', '<meta property="og:title" content="Bimbel TKA - Persiapan Tes Kemampuan Akademik Pusmendik Kemendikdasmen | Next Level Study">', [System.Text.RegularExpressions.RegexOptions]::Singleline)
$html = [System.Text.RegularExpressions.Regex]::Replace($html, '<meta property="og:description" content=".*?">', '<meta property="og:description" content="Bimbingan belajar resmi persiapan Tes Kemampuan Akademik (TKA) mengacu pada standar Pusat Asesmen Pendidikan (Pusmendik) Kemendikdasmen RI. Mencakup Mata Pelajaran Wajib dan Pilihan untuk seleksi SNBP & pemetaan akademik terstandar.">', [System.Text.RegularExpressions.RegexOptions]::Singleline)
...
$html = [System.Text.RegularExpressions.Regex]::Replace($html, '(?s)<!-- Hero Section -->.*?<!-- Pillars Section -->', $newHero + "`r`n<!-- Pillars Section -->")

$kerangkaSection = @'
<!-- Kerangka Asesmen Pusmendik Section -->
<section id="kerangka-asesmen" class="py-20 px-container-margin-mobile md:px-container-margin-desktop max-w-7xl mx-auto scroll-mt-16">
    <div class="text-center max-w-3xl mx-auto mb-14 space-y-4">
        ...
        <p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
            Berdasarkan regulasi resmi <strong>Pusat Asesmen Pendidikan (Pusmendik) Kemendikdasmen</strong>, TKA diselenggarakan untuk menyediakan pelaporan capaian akademik terstandar nasional yang objektif dan adil bagi seluruh murid di Indonesia.
        </p>
    </div>
...
$html = [System.Text.RegularExpressions.Regex]::Replace($html, '(?s)<!-- Programs Bento Grid -->', $kerangkaSection + "`r`n<!-- Programs Bento Grid -->")

[System.IO.File]::WriteAllText($tkaPath, $html, [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllText($bimbelTkaPath, $html, [System.Text.Encoding]::UTF8)

Write-Host "SUCCESS: Updated tka/index.html and bimbel-tka/index.html with Pusmendik Kemendikdasmen standards!"
