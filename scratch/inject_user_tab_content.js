                        ...
                        <div class="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                ...
                                <div @click="setUserRole('content_editor', 'Content Editor')"
                                    ...
                                    <div class="flex items-center justify-between gap-2 mb-1.5">
                                        <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200">Content Editor</span>
                                ...
                                <div @click="setUserRole('koordinator_pengajar', 'Koordinator Pengajar')"
                                    ...
                                    <div class="flex items-center justify-between gap-2 mb-1.5">
                                        <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200">Koordinator Pengajar</span>
                                ...
                                <div @click="setUserRole('customer_service', 'Customer Service')"
                                    ...
                                    <div class="flex items-center justify-between gap-2 mb-1.5">
                                        <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-200">Customer Service</span>
                                ...
                                <div @click="setUserRole('tutor_mentor', 'Tutor / Mentor Ahli')"
                                    ...
                                    <div class="flex items-center justify-between gap-2 mb-1.5">
                                        <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-200">Tutor / Mentor</span>
...
// Insert after pengajar tab view closing tag
if (!html.includes('<!-- ==========================================\n                 4. USER MANAGEMENT')) {
    const pengajarTarget = '</div>\n\n            <!-- ==========================================\n                 3. DAFTAR PENGAJAR';
    // Find the end of pengajar tab (before modals)
    const targetModal = '<!-- ==========================================\n         EVENT / AGENDA MODAL';
    html = html.replace(targetModal, userTabHtml + '\n\n    ' + targetModal);
}

fs.writeFileSync('nlsadmin/index.html', html, 'utf8');
console.log('✅ User Management Content Sections injected successfully into nlsadmin/index.html');
