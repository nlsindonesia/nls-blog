...
$newKalSubmenu = @'
                        <!-- Dropdown Submenu: Create Event, Present Event, & Trash Event -->
                        <div x-show="isKalenderDropdownOpen" x-cloak class="border-l-2 border-sky-300 dark:border-sky-800 ml-4 pl-2.5 pt-1 space-y-1.5">
                            <!-- Submenu 1: Create Event -->
                            <button type="button" @click="openCreateEventView()"
                                :class="activeTab === 'kalender' && kalenderView === 'create' ? 'submenu-btn-active' : 'submenu-btn-inactive'"
...
$newBeritaSubmenu = @'
                        <!-- Dropdown Submenu: Create News, Present News, & Trash News -->
                        <div x-show="isBeritaDropdownOpen" x-cloak class="border-l-2 border-emerald-300 dark:border-emerald-800 ml-4 pl-2.5 pt-1 space-y-1.5">
                            <!-- Submenu 1: Create News -->
                            <button type="button" @click="openCreateNewsView()"
                                :class="activeTab === 'berita' && beritaView === 'create' ? 'submenu-berita-active' : 'submenu-btn-inactive'"
...
$newPengajarSubmenu = @'
                        <!-- Dropdown Submenu: Add Teacher, Present Teacher, & Trash Teacher -->
                        <div x-show="isPengajarDropdownOpen" x-cloak class="border-l-2 border-indigo-300 dark:border-indigo-800 ml-4 pl-2.5 pt-1 space-y-1.5">
                            <!-- Submenu 1: Add Teacher -->
                            <button type="button" @click="openAddTeacherView()"
                                :class="activeTab === 'pengajar' && pengajarView === 'add' ? 'submenu-pengajar-active' : 'submenu-btn-inactive'"
...
# 4. Breadcrumb
$oldBreadcrumb = 'x-text="activeTab === ''kalender'' ? (kalenderView === ''create'' ? ''Kalender Event / Create Event'' : ''Kalender Event / Present Event'') : (activeTab === ''berita'' ? (beritaView === ''create'' ? ''Berita & Artikel / Create News'' : ''Berita & Artikel / Present News'') : (pengajarView === ''add'' ? ''Daftar Pengajar / Add Teacher'' : ''Daftar Pengajar / Present Teacher''))"'

$newBreadcrumb = 'x-text="activeTab === ''kalender'' ? (kalenderView === ''create'' ? ''Kalender Event / Create Event'' : (kalenderView === ''trash'' ? ''Kalender Event / Trash Event'' : ''Kalender Event / Present Event'')) : (activeTab === ''berita'' ? (beritaView === ''create'' ? ''Berita & Artikel / Create News'' : (beritaView === ''trash'' ? ''Berita & Artikel / Trash News'' : ''Berita & Artikel / Present News'')) : (pengajarView === ''add'' ? ''Daftar Pengajar / Add Teacher'' : (pengajarView === ''trash'' ? ''Daftar Pengajar / Trash Teacher'' : ''Daftar Pengajar / Present Teacher'')))"'
...
$kalenderAnchor = '                    </div>' + "`n`n" + '                <!-- =========================================================================' + "`n" + '                     TAB 2: MANAJEMEN BERITA & ARTIKEL'
$content = $content.Replace($kalenderAnchor, '                    </div>' + "`n" + $kalenderTrashView + "`n`n" + '                <!-- =========================================================================' + "`n" + '                     TAB 2: MANAJEMEN BERITA & ARTIKEL')
...
$beritaAnchor = '                    </div>' + "`n`n" + '                </div>' + "`n`n" + '                <!-- =========================================================================' + "`n" + '                     TAB 3: MANAJEMEN DAFTAR PENGAJAR'
$content = $content.Replace($beritaAnchor, '                    </div>' + "`n" + $beritaTrashView + "`n`n" + '                </div>' + "`n`n" + '                <!-- =========================================================================' + "`n" + '                     TAB 3: MANAJEMEN DAFTAR PENGAJAR')
...
$pengajarAnchor = '                    </div>' + "`n" + '                </div>' + "`n`n" + '            </main>'
$content = $content.Replace($pengajarAnchor, '                    </div>' + "`n" + $pengajarTrashView + "`n" + '                </div>' + "`n`n" + '            </main>')
...
Write-Host "SUCCESS: Applied Trash Submenus and Soft-Delete System to /nlsadmin!"
