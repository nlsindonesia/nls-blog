    ...
    const NlsSSO = {
        ...
        setLocalSession(session) {
            ...
            try {
                ...
                const avatar = session.avatar && !session.avatar.includes('article-placeholder') && !session.avatar.includes('nls-logo-300') && !session.avatar.includes('unsplash.com') ? session.avatar : DEFAULT_AVATAR;
